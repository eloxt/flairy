...
/**
 * Incrementally tracks streaming output with bounded memory. Ported from
 * pi-coding-agent (tools/output-accumulator.ts), unchanged except import paths.
 *
...
export class OutputAccumulator {
  ...
  constructor(options: OutputAccumulatorOptions = {}) {
    ...
    this.tempFilePrefix = options.tempFilePrefix ?? 'flairy-output'
  }

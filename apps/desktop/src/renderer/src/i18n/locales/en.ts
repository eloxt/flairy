...
const en = {
  ...
  panel: {
    ...
    runOpenLog: 'View run log',
    transcriptTitle: 'Run log — {{run}}',
    transcriptEmpty: 'Nothing logged yet.',
    transcriptTruncated: 'oldest entries trimmed',
    transcriptReadOnly: 'read-only',
    transcriptThought: 'thinking…',
    transcriptInput: 'input',
    transcriptAllowed: 'Allowed',
    transcriptDenied: 'Denied',
    transcriptOutcome: 'Outcome: {{outcome}}',
    transcriptOpenRaw: 'Open raw file',

...
const en = {
  ...
  chat: {
    ...
    showMore: 'Show more',
    showLess: 'Show less',
    cardCompareHint: 'Scroll horizontally to compare all options.',
    cardEmpty: 'No data to display.',
    cardUnavailable: 'This content could not be displayed. You can ask for a text version.',
    cardNotice_partial: 'Some entries could not be displayed.',
    cardNotice_truncated: 'This content exceeds the display limit; only the first part is shown.',
    cardNotice_recovered: 'Generation was interrupted; this content may be incomplete.',
    cardStatus_done: 'Completed',
    cardStatus_active: 'In progress',
    cardStatus_pending: 'Pending',
    cardStatus_failed: 'Failed',
    cardSent: 'Sent',
    cardPreviewOnly: 'Preview only — no action was sent.',
    cardData: 'View data',
    cardValue: 'Value',
    cardArtifact: 'Generated file',
    cardFileUnavailable: 'This file is unavailable on this device. It may have been moved or deleted.',
    cardPreview: 'Preview',
    cardReveal: 'Show in folder',
    cardSave: 'Save a copy',
    cardActionDone: 'Done',

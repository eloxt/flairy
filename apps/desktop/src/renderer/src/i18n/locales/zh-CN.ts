...
const zhCN: typeof En = {
  ...
  chat: {
    ...
    retryMessage: '重试',
    submitEdit: '提交',
    confirmEditTitle: '替换这条消息？',
    confirmRetryTitle: '从这条消息重试？',
    rerunWarning: '这条消息及下方的所有消息都会被永久丢弃，之后无法恢复或回看。',
    showMore: '展开',
    showLess: '收起',
    cardCompareHint: '可横向滚动查看全部选项。',
    cardEmpty: '暂无可显示的数据。',
    cardUnavailable: '这部分内容未能显示，可以请我用文字重新说明。',
    cardNotice_partial: '部分条目未能显示。',
    cardNotice_truncated: '内容超出显示上限，当前仅显示前一部分。',
    cardNotice_recovered: '内容未完整生成，当前显示已恢复的部分。',
    cardStatus_done: '已完成',
    cardStatus_active: '进行中',
    cardStatus_pending: '待处理',
    cardStatus_failed: '失败',
    cardSent: '已发送',
    cardPreviewOnly: '仅预览，未执行操作。',
    cardData: '查看数据',
    cardValue: '数值',
    cardArtifact: '生成的文件',
    cardFileUnavailable: '当前设备无法找到此文件，文件可能已移动或删除。',
    cardPreview: '预览',
    cardReveal: '在文件夹中显示',
    cardSave: '另存为',
    cardActionDone: '已完成',

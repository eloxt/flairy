...
const api: FlairyApi = {
  ...
  unwatchSession: (sessionId) => ipcRenderer.invoke(IPC.AgentUnwatchSession, sessionId),
  ...
  accessArtifact: (args) => ipcRenderer.invoke(IPC.ArtifactAccess, args),
  ...
  readWorkerRunTranscript: (runId) => ipcRenderer.invoke(IPC.WorkerRunTranscript, runId),
